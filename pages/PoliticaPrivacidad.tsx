    ...
    <div className="min-h-screen bg-[#ede3d6] py-12 px-4">
      <div className="max-w-3xl mx-auto bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-[#d6c7b2]">
        <div className="flex items-center gap-4 mb-8">
          <img src={LOGO_URL} alt="CateringApp" className="w-12 h-12 object-contain" referrerPolicy="no-referrer" />
        ...
        <div className="prose prose-stone max-w-none text-[#3d2b1f] space-y-6">
          <section>
            ...
            <p>
              CateringApp se compromete a proteger la privacidad de sus clientes y usuarios. Esta política describe cómo recopilamos, utilizamos y protegemos su información personal.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>Comunicarnos con usted respecto a sus presupuestos.</li>
