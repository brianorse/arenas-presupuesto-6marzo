...
import { User, Mail, Phone, Users, Calendar, Clock, MapPin } from 'lucide-react';
...
export default function Step1Datos({ client, setClient, onNext }) {
  ...
  const isValid = client.cliente_nombre && client.cliente_email && client.pax > 0 && client.fecha_evento;
